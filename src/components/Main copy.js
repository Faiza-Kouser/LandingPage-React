...
const Main = (prop) => {
  ...
  return (
    <div className={prop.colorMain}>
        <div className='img'>
         <img src ={image2} alt="display-picture" className='display-pic'/>
        </div>

        <div className={'content-div'}>
        <p className={`${class1} ${newClass}`}>Chiristian Louboutin</p>
        <p className='sub-heading'>DESIGNER</p>
        ...
        <p className='content'>An artist of considerable range.Chet Faker- naem taken byMelbourne raised, Brooklyn-based
